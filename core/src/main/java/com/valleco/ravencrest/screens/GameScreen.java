...
public class GameScreen implements Screen {
    ...
    public void show() {
        ...
        Texture keyTexture = new Texture(Gdx.files.internal("PlaceHolders/Sprites/key1.png"));
        engine.addEntity(EntityFactory.createItem(150, 150, keyTexture));
        Texture coinTexture = new Texture(Gdx.files.internal("PlaceHolders/Sprites/coin1.png"));
        ...
        npcTexture = new Texture(Gdx.files.internal("PlaceHolders/Sprites/Eidol1.png"));
